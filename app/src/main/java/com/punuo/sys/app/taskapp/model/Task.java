...
public class Task {
    ...
    public static List<TaskInfo> newTasks = new ArrayList<TaskInfo>();
    public static List<TaskInfo> unfinishedTasks = new ArrayList<TaskInfo>();
    public static List<TaskInfo> finishedTasks = new ArrayList<TaskInfo>();
